...
interface ElementViewBuilder<T extends AnyTypes> extends LikeC4ViewBuilder<T, T['Fqn'], Expression> {
}
...
declare function $expr<Types extends AnyTypes>(expr: ViewPredicate.Expression<Types> | Expression): Expression;
...
declare namespace Types {
    ...
    type ToParsedLikeC4Model<T> = T extends AnyTypes ? ParsedLikeC4Model<T['ElementKind'], T['RelationshipKind'], T['Tag'], T['Fqn'], T['ViewId'], T['DeploymentFqn']> : never;
